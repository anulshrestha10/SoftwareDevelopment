...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mandala_circle', '0016_auto_20210913_1841'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='mandala_circle.cart')),
            ],
        ),
        migrations.CreateModel(
            name='CartProduct',
            fields=[
                ...
                ('subtotal', models.PositiveIntegerField()),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mandala_circle.cart')),
